...
module.exports = class EmailService extends Service {
    ...
    async sendFilmsCSV(userEmail, csvStream) {
        /*
         * Envoie un email a un utilisateur avec la liste des films.
         * La fonction utilise le transporteur Nodemailer pour envoyer un email.
         * @param {string} userEmail - Adresse email du destinataire.
         * @param {PassThrough} csvStream - Films en CSV.
         *
         */
        const mailPayload = {
            from: 'Projet R605 <no-reply.r605@etu.unilim.fr>',
            to: userEmail,
            subject: 'Liste des films',
            text: `En PJ, la liste des films au format CSV`,
            attachments: [{
                filename: 'films.csv',
                content: csvStream
            }]
